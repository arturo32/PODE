...
public class AdministradorControlador extends GenericControlador<Administrador, AdministradorDTO, Long> {
	...
	@Override
	protected GenericoServico<Administrador, AdministradorDTO, Long> service() {
		return this.service;
	}
}
