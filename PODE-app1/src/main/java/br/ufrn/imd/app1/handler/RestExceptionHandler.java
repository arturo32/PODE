package br.ufrn.imd.app1.handler;

import br.ufrn.imd.app1.exception.EntidadeNaoEncontradaException;
import br.ufrn.imd.app1.exception.NegocioException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(@NotNull HttpMessageNotReadableException ex,
		...
		return buildResponseEntity(new br.ufrn.imd.app1.handler.ApiError(HttpStatus.BAD_REQUEST, "Problemas de formação do JSON"));
	}
	 ...
	 */
	@ExceptionHandler(br.ufrn.imd.app1.exception.EntidadeNaoEncontradaException.class)
	protected ResponseEntity<Object> handlerExceptionEntityNotFound(EntidadeNaoEncontradaException entidadeNaoEncontradaException) {
		br.ufrn.imd.app1.handler.ApiError apiError = new br.ufrn.imd.app1.handler.ApiError(HttpStatus.NOT_FOUND, this.getSimpleMessage(entidadeNaoEncontradaException));
	...
	protected ResponseEntity<Object> handlerExceptionBusiness(NegocioException negocioException) {
		br.ufrn.imd.app1.handler.ApiError apiError = new br.ufrn.imd.app1.handler.ApiError(HttpStatus.BAD_REQUEST, this.getSimpleMessage(negocioException));
	...
	protected ResponseEntity<Object> handlerExceptionConstraintViolation(JDBCException jdbcException) {
		br.ufrn.imd.app1.handler.ApiError apiError = new br.ufrn.imd.app1.handler.ApiError(HttpStatus.INTERNAL_SERVER_ERROR, this.getJDBCExceptionMessage(jdbcException));
	 ...
	 */
	private br.ufrn.imd.app1.handler.ApiSpecificError getApiSpecificErrorJDBCException(JDBCException jdbcException) {
		br.ufrn.imd.app1.handler.ApiSpecificError apiSpecificError = new ApiSpecificError("JDBCException");
